...
export default function LessonManager({ course, form, setForm, add, update, remove, removeMain, selectMain, removeResource, retryResource, close }) {
