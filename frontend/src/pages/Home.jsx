    ...
    <div className="home">
      ...
      <section className="bento" id="explore">
        ...
        <div className="bento-cell cell-quiz">
          ...
          <p>
            Gamified quizzes and leaderboards make studying something you look forward to.
          </p>

          <div className="quiz-bar">
            <div className="quiz-bar-fill"></div>
          </div>
      ...
      <section className="how" id="how">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>Tell EDUNova your goals and level — the AI builds a picture of you in seconds.</p>
          </div>

          <div className="step">
            <div className="step-num">02</div>
            <h3>Pick your path</h3>
            <p>Browse courses or let the AI recommend the perfect starting point.</p>
          </div>
