...
export default function StripeCheckout({ initialOrder }) {
  ...
  useEffect(() => {
    ...
    if (paymentResult === "cancelled" || order.status !== "pending" ||
        order.paymentType !== "course" || Number(order.totalAmount) <= 0) return;
