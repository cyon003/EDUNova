    ...
    <div className="home">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <Link to="/courses" className="btn-ghost btn-large">
              Browse Courses
            </Link>
          </div>
        </div>
      ...
      <section className="bento" id="explore">
        ...
        <div className="bento-cell cell-tutor">
          ...
          <div className="tutor-chat">
            ...
            <div className="chat-row chat-ai">
              Plants convert light into energy using chlorophyll — let's break it down step by step →
            </div>
          </div>
        </div>
        ...
        <div className="bento-cell cell-courses">
          ...
          <p>
            EDUNova maps your strengths and gaps, then adapts as you grow.
          </p>
        ...
        <div className="bento-cell cell-quiz">
          ...
          <p>
            Gamified quizzes and leaderboards make studying something you look
            forward to.
          </p>
      ...
      <section className="how" id="how">
        ...
        <div className="steps">
          ...
          <div className="step">
            ...
            <p>
              Tell EDUNova your goals and current level — the AI builds a
              picture of you in seconds.
            </p>
          </div>
          ...
          <div className="step">
            ...
            <p>
              Browse 200+ courses or let the AI recommend the perfect
              starting point.
            </p>
          </div>
          ...
          <div className="step">
            ...
            <p>
              Study with AI support, track your mastery, and celebrate every
              milestone.
            </p>
          </div>
      ...
      <section className="cta-banner">
        ...
        <p className="cta-sub">
          Join learners already growing with EDUNova.
        </p>
      ...
      <footer className="home-footer">
        ...
        <p className="footer-copy">
          © 2026 EDUNova. Empowering every learner with AI.
        </p>
